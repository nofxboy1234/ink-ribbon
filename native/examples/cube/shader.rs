...
/*
    ...
    Cmdline:
        sokol-shdc -i examples/cube/shader.glsl -o examples/cube/shader.rs -l glsl430:glsl300es:metal_macos:hlsl5 -f sokol_rust
...
*/
pub const VS_SOURCE_GLSL300ES: [u8; 266] = [
...
*/
pub const FS_SOURCE_GLSL300ES: [u8; 175] = [
    0x23, 0x76, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x20, 0x33, 0x30, 0x30, 0x20, 0x65, 0x73, 0x0a,
